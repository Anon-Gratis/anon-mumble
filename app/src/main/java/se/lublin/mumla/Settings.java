...
public class Settings {
    ...
    // Anon fork: Tor is always on. The app embeds its own tor daemon (no Orbot)
    // and Mumla refuses to attempt clearnet connects.
    public static final Boolean DEFAULT_USE_TOR = true;
